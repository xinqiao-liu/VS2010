...
namespace KM.WLData.Entry
{
    public static class Customer
    {
        ...
        public static bool Insert(SqlCommand cmd, Model.Customer c)
        {
        ...
        public static bool Update(SqlCommand cmd, string old_name, string old_tel, Model.Customer c)
        {
        ...
        public static List<Model.Customer> Reads(SqlCommand cmd)
        {
