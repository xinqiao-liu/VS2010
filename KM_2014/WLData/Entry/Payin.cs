...
namespace KM.WLData.Entry
{
    public static class Payin
    {
        ...
        public static bool Insert(SqlCommand cmd, Model.Payin item)
        {
        ...
        public static bool Update(SqlCommand cmd, Model.Payin item)
        {
        ...
        public static List<Model.Payin> Reads(SqlCommand cmd, DateTime date)
        {
            List<Model.Payin> list = new List<Model.Payin>();
            ...
            using (SqlDataReader rdr = cmd.ExecuteReader())
            {
                while (rdr.Read())
                {
                    Model.Payin item = new Model.Payin();
