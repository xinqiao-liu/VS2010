...
namespace KM.WLData.Entry
{
    public sealed class YFB
    {
        ...
        public static bool Insert(SqlCommand cmd, Model.YFB item)
        {
        ...
        public static bool Update(SqlCommand cmd, string old_name, Model.YFB item)
        {
        ...
        public static List<Model.YFB> Reads(SqlCommand cmd)
        {
            List<Model.YFB> list = new List<Model.YFB>();
