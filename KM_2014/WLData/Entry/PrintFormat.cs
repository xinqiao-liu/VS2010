...
namespace KM.WLData.Entry
{
    ...
    {
        public static bool Update(SqlCommand cmd, Model.PrintFormat format)
        {
        ...
        public static List<Model.PrintFormat> Reads(SqlCommand cmd)
        {
            List<Model.PrintFormat> list = new List<Model.PrintFormat>();
            ...
            using (SqlDataReader rdr = cmd.ExecuteReader())
            {
                while (rdr.Read())
                {
                    Model.PrintFormat format = new Model.PrintFormat();
