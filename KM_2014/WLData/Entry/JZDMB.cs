...
namespace KM.WLData.Entry
{
    ...
    {
        private static Model.JZDMB ToJZDMB(SqlDataReader rdr)
        {
            Model.JZDMB item = new Model.JZDMB();

            item.Code = rdr["code"].ToString();
            item.Name = rdr["name"].ToString();
            item.Value = Convert.ToDecimal(rdr["value"]);
            item.Mode = (Model.JZMode)rdr["mode"];
        ...
        public static bool Insert(SqlCommand cmd, Model.JZDMB item)
        {
        ...
        public static bool Update(SqlCommand cmd, string old_code, Model.JZDMB item)
        {
        ...
        public static Model.JZDMB Read(SqlCommand cmd, string code)
        {
        ...
        public static List<Model.JZDMB> Reads(SqlCommand cmd)
        {
            List<Model.JZDMB> list = new List<Model.JZDMB>();
        ...
        public static List<Model.JZCPH> Read_JZCPH(SqlCommand cmd)
        {
            List<Model.JZCPH> list = new List<Model.JZCPH>();
            ...
            using (SqlDataReader rdr = cmd.ExecuteReader())
            {
                while (rdr.Read())
                {
                    Model.JZCPH item = new Model.JZCPH();
                    item.Code = rdr["code"].ToString();
                    item.Name = rdr["name"].ToString();
