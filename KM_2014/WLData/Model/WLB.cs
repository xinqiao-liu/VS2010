...
namespace KM.WLData.Model
{
    ...
    public sealed class WLB
    {
        ...
        //创建测试物流数据
        public static KM.WLData.Model.WLB CreateTestItem()
        {
            KM.WLData.Model.WLB item = new KM.WLData.Model.WLB();
        ...
        public static WLB ToTarget(object o)
        {
            ...
            if (o is KM.WLData.Model.WLB)
                return (o as KM.WLData.Model.WLB);
            else
        ...
        {
            list.Items.Clear();
            list.Items.Add(KM.WLData.Model.SKType.现金);
            if (allowDF) list.Items.Add(KM.WLData.Model.SKType.到付);
            if (allowJZ) list.Items.Add(KM.WLData.Model.SKType.记账);
        ...
        {
            list.Items.Clear();
            list.Items.Add(KM.WLData.Model.YDType.本地);
        }

        public static void ZTTypeList(ComboBox list)
        {
            list.Items.Clear();
            list.Items.Add(KM.WLData.Model.ZTType.接货);
            list.Items.Add(KM.WLData.Model.ZTType.装车);
            list.Items.Add(KM.WLData.Model.ZTType.卸车);
            list.Items.Add(KM.WLData.Model.ZTType.取货);
            list.Items.Add(KM.WLData.Model.ZTType.作废);
        }
    }
}
