...
namespace KYData_MSSQL
{
    ...
    {
        public String KYZBM { get; set; }
        public String KYZMC { get; set; }
        public String JSDBH { get; set; }
        ...
        public Int32 XBBS { get; set; }
        public Int32 XBJS { get; set; }
        public Int32 JSZS { get; set; }
        public Decimal KPPK { get; set; }
        public Decimal KBXF { get; set; }
        public Decimal KFJF { get; set; }
        public Decimal JSPK { get; set; }
        public Decimal XBYF { get; set; }
        public Decimal XBK { get; set; }
        public Decimal HJJE { get; set; }
        public String FCBZ { get; set; }
        public Decimal FKJE { get; set; }
        public String JSCZ { get; set; }
        public Decimal PKBL { get; set; }
        public Decimal XBBL { get; set; }
        public Decimal PKDLF { get; set; }
        public Decimal XBDLF { get; set; }
        public Int32 BXBZ { get; set; }
        public Int32 FJBZ { get; set; }
        public Decimal DBFK { get; set; }
        public String JZBZ { get; set; }
        public DateTime JZRQ { get; set; }
        public String JZDBH { get; set; }
        public String JZDWMC { get; set; }
        public String JZCZY { get; set; }
        public Decimal RYF { get; set; }

        public override String ToString()
        {
            return String.Format(" {0}{1,06}{2,07}{3,04}{4,10}{5,08}", this.RQ.ToString("yyyy-MM-dd"), this.CC, this.FCSJ, this.JSZS.ToString(), this.JSPK.ToString("N2"), this.ZDZ);
        }

        //创建并获取结算单编号
        public static String CreateBH(SqlConnection conn, int bits)
        {
            try
            {
                ...
                using (SqlCommand cmd = conn.CreateCommand())
                {
                    ...
                    int bh = Convert.ToInt32(cmd.ExecuteScalar());
                    if(bh == 0)
                        return String.Empty;
                    else
                        return String.Format("{0:D" + bits.ToString() + "}", bh);
                }
            }
            catch (Exception ex)
            {
                throw new ApplicationException("创建并获取结算单编号异常：" + ex.Message);
            }
        }
        ...
        public static Boolean Insert(SqlConnection conn, JSD item)
        {
            try
            {
                if (conn.State != ConnectionState.Open) conn.Open();
        ...
        public static Boolean Delete(SqlConnection conn, String kyzbm, DateTime date, String cc)
        {
            try
            {
                if (conn.State != ConnectionState.Open) conn.Open();
                ...
                using (SqlCommand cmd = conn.CreateCommand())
                {
                    return Delete(cmd, kyzbm, date, cc);
                }
            }
            catch (Exception ex)
            {
