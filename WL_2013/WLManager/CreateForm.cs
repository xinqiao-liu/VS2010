...
namespace WLManager
{
    public partial class CreateForm : Form
    {
        ...
        private WLDataModelLayer.WLB Build()
        {
            ...
            item.Username = WLDataLogicLayer.User.LoginUser.Username;
        ...
        {
            using (CreateForm ydCreateForm = new CreateForm())
            {
        ...
        private void btnRefreshTotalAmount_Click(object sender, EventArgs e)
        {
            try
            {
                this.txtTotalAmount.Text = WLDataLogicLayer.WLB.GetUserTotal(WLDataLogicLayer.User.LoginUser.Userid).ToString("N2");
            }
            catch (Exception ex) { MessageBox.Show(ex.Message, "异常", MessageBoxButtons.OK, MessageBoxIcon.Error); }
        }
        ...
        private void btnFind_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    this.OriginalWLB = WLDataLogicLayer.WLB.Read(WLDataLogicLayer.Setting.NodeCode, sn);
