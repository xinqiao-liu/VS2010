...
namespace WLDataModelLayer
{
    ...
    public sealed class ZDB
    {
        ...
        public static ZDB ToTarget(object o)
        {
            ...
            if (o is WLDataModelLayer.ZDB)
                return (o as WLDataModelLayer.ZDB);
            else
        ...
        {
            list.Items.Clear();
            list.Items.Add(WLDataModelLayer.RoundingType.取整);
            list.Items.Add(WLDataModelLayer.RoundingType.保留角);
            list.Items.Add(WLDataModelLayer.RoundingType.保留分);
