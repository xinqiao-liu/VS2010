...
namespace WLDataAccessLayer
{
    ...
    {
        private static WLDataModelLayer.User ToUser(SqlDataReader rdr)
        {
            WLDataModelLayer.User user = new WLDataModelLayer.User();
        ...
        public static bool Insert(SqlCommand cmd, WLDataModelLayer.User user)
        {
        ...
        public static bool Update(SqlCommand cmd, string old_userid, WLDataModelLayer.User user)
        {
        ...
        public static WLDataModelLayer.User Read(SqlCommand cmd, string userid)
        {
        ...
        public static List<WLDataModelLayer.User> Reads(SqlCommand cmd)
        {
            List<WLDataModelLayer.User> list = new List<WLDataModelLayer.User>();
