...
namespace WLDataAccessLayer
{
    ...
    {
        //读取器输出网点信息
        private static WLDataModelLayer.Node ToNode(SqlDataReader rdr)
        {
            WLDataModelLayer.Node node = new WLDataModelLayer.Node();
        ...
        //插入网点信息
        public static bool Insert(SqlCommand cmd, WLDataModelLayer.Node node)
        {
        ...
        //更新网点信息
        public static bool Update(SqlCommand cmd, WLDataModelLayer.Node node)
        {
        ...
        //读取指定网点信息
        public static WLDataModelLayer.Node Read(SqlCommand cmd, string code)
        {
        ...
        //读取全部网点信息
        public static List<WLDataModelLayer.Node> Reads(SqlCommand cmd)
        {
            List<WLDataModelLayer.Node> list = new List<WLDataModelLayer.Node>();
        ...
        //读取网点-根据启用状态
        public static List<WLDataModelLayer.Node> Reads(SqlCommand cmd, bool enable)
        {
            List<WLDataModelLayer.Node> list = new List<WLDataModelLayer.Node>();
