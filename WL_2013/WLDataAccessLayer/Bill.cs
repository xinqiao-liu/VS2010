...
namespace WLDataAccessLayer
{
    ...
    {
        private static WLDataModelLayer.Bill ToBill(SqlDataReader rdr)
        {
            WLDataModelLayer.Bill bill = new WLDataModelLayer.Bill();
            ...
            bill.P_State = (WLDataModelLayer.BillState)Convert.ToChar(rdr["p_state"]);
            bill.CDT = Convert.ToDateTime(rdr["CDT"]);

            return bill;
        }

        public static bool Stepping(SqlCommand cmd, WLDataModelLayer.Bill bill, int n = 1)
        {
            bill.P_Index += n;
        ...
        public static bool Exists(SqlCommand cmd, string userid, WLDataModelLayer.BillState p_state)
        {
        ...
        public static bool Insert(SqlCommand cmd, WLDataModelLayer.Bill bill)
        {
        ...
        public static bool Update(SqlCommand cmd, WLDataModelLayer.Bill bill)
        {
        ...
        public static WLDataModelLayer.Bill Read(SqlCommand cmd, string userid, WLDataModelLayer.BillState p_state)
        {
        ...
        public static List<WLDataModelLayer.Bill> Reads(SqlCommand cmd)
        {
            List<WLDataModelLayer.Bill> list = new List<WLDataModelLayer.Bill>();
        ...
        public static List<WLDataModelLayer.Bill> Reads(SqlCommand cmd, string userid)
        {
            List<WLDataModelLayer.Bill> list = new List<WLDataModelLayer.Bill>();
        ...
        public static bool SetState(SqlCommand cmd, string userid, int p_start, WLDataModelLayer.BillState p_state)
        {
