...
namespace WLDataAccessLayer
{
    ...
    {
        private static WLDataModelLayer.EndOfDay ToEndOfDay(SqlDataReader rdr)
        {
            WLDataModelLayer.EndOfDay item = new WLDataModelLayer.EndOfDay();
        ...
        public static bool Insert(SqlCommand cmd, WLDataModelLayer.EndOfDay item)
        {
        ...
        public static List<WLDataModelLayer.EndOfDay> Reads(SqlCommand cmd, DateTime date)
        {
            List<WLDataModelLayer.EndOfDay> list = new List<WLDataModelLayer.EndOfDay>();
