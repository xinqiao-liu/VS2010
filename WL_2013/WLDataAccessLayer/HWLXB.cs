...
namespace WLDataAccessLayer
{
    public static class HWLXB
    {
        ...
        public static List<WLDataModelLayer.HWLXB> Reads(SqlCommand cmd)
        {
            List<WLDataModelLayer.HWLXB> list = new List<WLDataModelLayer.HWLXB>();
            ...
            using (SqlDataReader rdr = cmd.ExecuteReader())
            {
                while (rdr.Read())
                {
                    WLDataModelLayer.HWLXB item = new WLDataModelLayer.HWLXB();
