...
{    
    public static class ZDHZB
    {
        ...
        public static bool Insert(SqlCommand cmd, WLDataModelLayer.ZDHZB item)
        {
        ...
        public static List<WLDataModelLayer.ZDHZB> Reads(SqlCommand cmd, int year, int month)
        {
            ...
            using (SqlDataReader rdr = cmd.ExecuteReader())
            {
                while (rdr.Read())
                {
                    WLDataModelLayer.ZDHZB item = new WLDataModelLayer.ZDHZB();
