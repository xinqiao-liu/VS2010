...
namespace WLDataAccessLayer
{
    public static class WLT
    {
        ...
        public static bool Insert(SqlCommand cmd, WLDataModelLayer.WLT item)
        {
        ...
        public static List<WLDataModelLayer.WLT> Reads(SqlCommand cmd, string node, DateTime date, string sn)
        {
            List<WLDataModelLayer.WLT> list = new List<WLDataModelLayer.WLT>();
            ...
            using (SqlDataReader rdr = cmd.ExecuteReader())
            {
                while (rdr.Read())
                {
                    WLDataModelLayer.WLT item = new WLDataModelLayer.WLT();
        ...
        public static List<WLDataModelLayer.WLT> Reads(SqlCommand cmd, string node, string sn)
        {
            List<WLDataModelLayer.WLT> list = new List<WLDataModelLayer.WLT>();
