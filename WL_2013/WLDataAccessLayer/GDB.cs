...
namespace WLDataAccessLayer
{
    ...
    {
        private static WLDataModelLayer.GDB ToGDB(SqlDataReader rdr)
        {
            WLDataModelLayer.GDB item = new WLDataModelLayer.GDB();
        ...
        public static bool Insert(SqlCommand cmd, WLDataModelLayer.GDB item)
        {
        ...
        public static List<WLDataModelLayer.GDB> Reads(SqlCommand cmd, string node, DateTime date)
        {
            List<WLDataModelLayer.GDB> list = new List<WLDataModelLayer.GDB>();
        ...
        public static List<WLDataModelLayer.GDB> ReadByUID(SqlCommand cmd, string node, DateTime date, string uid)
        {
            List<WLDataModelLayer.GDB> list = new List<WLDataModelLayer.GDB>();
        ...
        public static List<WLDataModelLayer.GDB> ReadByRecordType(SqlCommand cmd, string node, DateTime date, string record_type)
        {
            List<WLDataModelLayer.GDB> list = new List<WLDataModelLayer.GDB>();
