...
namespace WLDataAccessLayer
{
    public static class BZXXB
    {
        ...
        public static List<WLDataModelLayer.BZXXB> Reads(SqlCommand cmd)
        {
            List<WLDataModelLayer.BZXXB> list = new List<WLDataModelLayer.BZXXB>();
            ...
            using (SqlDataReader rdr = cmd.ExecuteReader())
            {
                while (rdr.Read())
                {
                    WLDataModelLayer.BZXXB item = new WLDataModelLayer.BZXXB();
